...
$groupform->set_data($toform);


$courseurl = new moodle_url('/mod/objective/viewgroup.php', array('id' => $id));
...
if ($groupform->is_cancelled()) {
  ...
  $lastinsertid = $DB->insert_record('objective_groups', $fromform);
