...
require_once('competition_form.php');
...
$competitionform = new newcompetition_form();
...
$competitionform->set_data($toform);


$courseurl = new moodle_url('/mod/objective/viewcompetition.php', array('id' => $id));
//Form processing and displaying is done here
if ($competitionform->is_cancelled()) {

  redirect($courseurl);


    //Handle form cancel operation, if cancel button is present on form
} else if ($fromform = $competitionform->get_data()) {
    global $DB;
  //In this case you process validated data. $mform->get_data() returns data posted in form.

  $lastinsertid = $DB->insert_record('objective_competition', $fromform);
