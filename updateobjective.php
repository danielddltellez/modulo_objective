...
if(isset($_POST['idobj1'])){
$record1 = new stdClass();
$record1-> id = $_POST['idobj1'];
...
if(isset($_POST['idobj2'])){
$record2 = new stdClass();
$record2-> id = $_POST['idobj2'];
...
if(isset($_POST['idobj3'])){
$record3 = new stdClass();
$record3-> id = $_POST['idobj3'];
...
if(isset($_POST['idobj6'])){
$record6 = new stdClass();
$record6-> id = $_POST['idobj6'];
