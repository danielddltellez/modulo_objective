...
$update1-> id = $objetivoid;
$update1-> status = 1;
$updatestatus = $DB->update_record('objective_establishment', $update1);
echo 'Tu objetivo fue guardado con éxito';

} catch(\Throwable $e) {
    // PHP 7 
echo 'Error al enviar tu objetivo';
} 
}
