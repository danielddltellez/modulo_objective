...
try{
   ...
   // $mensaje= '¡Hola! Tu Gestor ha Finalizado con la revisión de tus Objetivos 2020,  para ingresa a revisar sus comentario, da clic aquí.~https://www.portal3i.mx/openlms/tripleI.php?email='.$email.'&courseid='.$idcursonot.'~.';
    $mensajerev= '¡Hola! Tu Gestor ha Finalizado el registro de sus comentarios en la Revisión Mitad de año (Autoevaluación), para conocer la retroalimentación registrada de cada objetivo, da clic aquí.~https://www.portal3i.mx/openlms/tripleI.php?key='.$cadena.'~.';
