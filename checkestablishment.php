...
foreach($resultcontrol as $valuecontrol){
    ...
    ?>
<form id="idcompetenciasfinal" method="POST" action="enviocompetenciasfinal.php">
<div class="w3-container">
        <div class="w3-row">
            <div class="w3-col l1">
                <p></p>
    ...
    if($rolcolaborador==1){
                ...
                echo '<div class="w3-col l9">
                    ...
                    foreach($resultcolaboradorfinal as $comportamiento2final){
                                ...
                                if($comportamiento2final->code==1){
                                    echo'<tr><td>'.$comportamiento2final->description.'</td>';
                                    echo'   <td>
                                                <input type="radio" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][valorfinal]" value="4"><label for="valores'.$comportamiento2final->id.'">4</label>
                                                <input type="radio" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][valorfinal]" value="3"><label for="valores'.$comportamiento2final->id.'">3</label>
                                                <input type="radio" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][valorfinal]" value="2"><label for="valores'.$comportamiento2final->id.'">2</label>
                                                <input type="radio" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][valorfinal]" value="1"><label for="valores'.$comportamiento2final->id.'">1</label>
                                            </td>';
                                    echo'   <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][idcompetenciafinal]" value="'.$comportamiento2final->idcompetencia.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][idcomportamientofinal]" value="'.$comportamiento2final->id.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][courseidfinal]" value="'.$comportamiento2final->courseid.'"></p></td>
                                    ...
                                    echo'<tr><td>'.$comportamiento2final->description.'</td>';
                                    echo'<td><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][valorfinal]"></p></td>';
                                    echo'   <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][idcompetenciafinal]" value="'.$comportamiento2final->idcompetencia.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][idcomportamientofinal]" value="'.$comportamiento2final->id.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][courseidfinal]" value="'.$comportamiento2final->courseid.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][useridfinal]" value="'.$USER->id.'"></p></td>
                                    ...
                                    echo'<tr><td>'.$comportamiento2final->description.'</td></tr>';
                                    echo'<tr><td><textarea class="w3-input w3-border" rows="4" cols="50" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][valorfinal]"></textarea></td>';
                                    echo'   <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][idcompetenciafinal]" value="'.$comportamiento2final->idcompetencia.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][idcomportamientofinal]" value="'.$comportamiento2final->id.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][courseidfinal]" value="'.$comportamiento2final->courseid.'"></p></td>
                                            <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamiento2final->id.'" name="valores['.$comportamiento2final->id.'][useridfinal]" value="'.$USER->id.'"></p></td>
        ...
        foreach($resultados2final as $valores2final){
                ...
                // print_r($resultado2);
                    ...
                    echo'<td>
                        <input type="radio" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][valorfinal]" value="4"><label for="valores'.$comportamientofinal2->id.'">4</label>
                        <input type="radio" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][valorfinal]" value="3"><label for="valores'.$comportamientofinal2->id.'">3</label>
                        <input type="radio" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][valorfinal]" value="2"><label for="valores'.$comportamientofinal2->id.'">2</label>
                        <input type="radio" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][valorfinal]" value="1"><label for="valores'.$comportamientofinal2->id.'">1</label>
                    </td>';
                    echo'<td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][idcompetenciafinal]" value="'.$comportamientofinal2->idcompetencia.'"></p></td>
                    <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][idcomportamientofinal]" value="'.$comportamientofinal2->id.'"></p></td>
                    <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][courseidfinal]" value="'.$comportamientofinal2->courseid.'"></p></td>
                    ...
                    echo'<tr>
                        <td>'.$comportamientofinal2->description.'</td>';
                    echo'<td><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][valorfinal]"></p></td>';
                    echo'<td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][idcompetenciafinal]" value="'.$comportamientofinal2->idcompetencia.'"></p></td>
                        <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][idcomportamientofinal]" value="'.$comportamientofinal2->id.'"></p></td>
                        <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][courseidfinal]" value="'.$comportamientofinal2->courseid.'"></p></td>
                        <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][useridfinal]" value="'.$USER->id.'"></p></td>
                    ...
                    echo'<tr><td><textarea class="w3-input w3-border" rows="4" cols="50" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][valorfinal]"></textarea></td></tr>';
                    echo'<td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][idcompetenciafinal]" value="'.$comportamientofinal2->idcompetencia.'"></p></td>
                    <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][idcomportamientofinal]" value="'.$comportamientofinal2->id.'"></p></td>
                    <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][courseidfinal]" value="'.$comportamientofinal2->courseid.'"></p></td>
                    <td style="display: none;"><p><input class="w3-input w3-border" type="text" id="valores'.$comportamientofinal2->id.'" name="valores['.$comportamientofinal2->id.'][useridfinal]" value="'.$USER->id.'"></p></td>
